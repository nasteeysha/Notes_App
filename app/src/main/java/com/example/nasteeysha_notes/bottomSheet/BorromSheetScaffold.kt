package com.example.nasteeysha_notes.bottomSheet
...
class BottomSheetState(
    ...
    internal val isHalfExpandedEnabled: Boolean
        get() = anchors.values.contains(BottomSheetValue.HalfExpanded)
    ...
    suspend fun show() {
        val targetValue =
            if (isHalfExpandedEnabled) BottomSheetValue.HalfExpanded
     ...
     * @throws [CancellationException] if the animation is interrupted
     */
    internal suspend fun expand() = animateTo(BottomSheetValue.Expanded)
...
fun ModalBottomSheetLayout(
    ...
    sheetState: BottomSheetState =
        rememberBottomSheetState(BottomSheetValue.Hidden),
            ...
            modifier = Modifier
                ...
                .semantics {
                    if (sheetState.isVisible) {
                        ...
                        if (sheetState.currentValue == BottomSheetValue.HalfExpanded) {
                            expand {
                            ...
                            collapse {
                                if (sheetState.confirmStateChange(BottomSheetValue.HalfExpanded)) {
...
private fun Modifier.bottomSheetSwipeable(
    ...
    val modifier = if (sheetHeight != null) {
        val anchors = if (sheetHeight < fullHeight / 2) {
            ...
            mapOf(
                fullHeight to BottomSheetValue.Hidden,
                fullHeight / 2 to BottomSheetValue.HalfExpanded,
